                  ...
                  <div className={`pt-3 ${style.form}`}>
                    <Form onSubmit={onFormSubmit}>
                      <Form.Group controlId="formEmail" className='pb-3'>
                        ...
                        <Form.Control type="email" placeholder="Email address" value={email} onChange={(e) => onChangeHandler(e, setEmail)}/>
                      </Form.Group>

                    <Form.Group controlId="formPassword">
                      <Form.Label className='text-left d-flex'>Password</Form.Label>
                      <Form.Control type="password" placeholder="Enter strong password" value={password} onChange={(e) => onChangeHandler(e,setPassword)}/> 

                      {error ? (
                            <Form.Text className="text-muted">
                            Your passwword must contain at least 8 characters, including a number
                          </Form.Text>
